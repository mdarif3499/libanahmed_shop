...
import 'package:ahmed_shop/screens/userScreen/authScreen/otpVerification/controller/user_opt_verification_screen_controller.dart';
...
class UserOtpVerrfication extends StatelessWidget {
  UserOtpVerrfication({super.key});

  final TextEditingController _otpController = TextEditingController();

  final UserOtpVerificationController controller =
      Get.put(UserOtpVerificationController());
