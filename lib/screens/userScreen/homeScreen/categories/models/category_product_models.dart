...
class CategoryProductModel {
    ...
    factory CategoryProductModel.fromRawJson(String str) => CategoryProductModel.fromJson(json.decode(str));
...
class SellerId {
    ...
    factory SellerId.fromRawJson(String str) => SellerId.fromJson(json.decode(str));
