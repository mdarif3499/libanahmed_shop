...
class UserMenuFavouriteModel {
    ...
    factory UserMenuFavouriteModel.fromRawJson(String str) => UserMenuFavouriteModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory UserMenuFavouriteModel.fromJson(Map<String, dynamic> json) => UserMenuFavouriteModel(
