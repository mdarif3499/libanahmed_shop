...
class ParcelDeliveryTrackingModel {
    bool? success;
    String? message;
    Data? data;

    ParcelDeliveryTrackingModel({
        this.success,
        this.message,
        this.data,
    });

    factory ParcelDeliveryTrackingModel.fromRawJson(String str) => ParcelDeliveryTrackingModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory ParcelDeliveryTrackingModel.fromJson(Map<String, dynamic> json) => ParcelDeliveryTrackingModel(
